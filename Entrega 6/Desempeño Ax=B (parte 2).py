...
# Tamaño de matrices
Nm= [2,5,10,12,15,20,30,40,45,50,55,60,75,100,125,160,200,250,300,350,500,600,800,1000,5000,10000]

Numcorridas=6

nombres=["A_invB_inv.txt","A_invB_npSolve.txt","A_invB_spSolve.txt","A_invB_spSolve_symmetric","A_invB_spSolve_pos","A_invB_spSolve_pos_overwrite"]
